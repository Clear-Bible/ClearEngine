...
{
    public class UpdateTextCorpusCommandHandler : IRequestHandler<
        UpdateTextCorpusCommand,
        RequestResult<TextCorpusFromDb>>
    {
        public Task<RequestResult<TextCorpusFromDb>>
            Handle(UpdateTextCorpusCommand command, CancellationToken cancellationToken)
        {
