...
{
    public class SyntaxTreeWordAlignmentModel :  IWordAlignmentModel, ISyntaxTreeWordAligner, IDisposable
    {
        private readonly ISyntaxTreeTrainableWordAligner _trainableAligner;
        ...
        public SyntaxTreeWordAlignmentModel(ISyntaxTreeTrainableWordAligner trainableAligner, string? prefFileName = null)
        {
        ...
        /// 
        /// </summary>
        /// <param name="parallelTextCorpus">Corpus SourceCorpus must be an EngineParallelTextRow.</param>
        ...
        public ITrainer CreateTrainer(IEnumerable<ParallelTextRow> parallelTextRows)
        {
            ...
            try
            {
                return new SyntaxTreeWordAlignmentModelTrainer(
                    _trainableAligner,
