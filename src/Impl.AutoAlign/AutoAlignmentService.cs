...
namespace ClearBible.Clear3.Impl.AutoAlign
{
    ...
    public class AutoAlignmentService : IAutoAlignmentService
    {
            ...
            )
        {
            ...
            List<MappedWords> links = Align2.AlignTheRest(topCandidate, terminals, sWords.Count, targetWords, tWords, model, preAlignment, useAlignModel, puncs, stopWords, goodLinks, goodLinkMinCount, badLinks, badLinkMinCount, sourceFuncWords, targetFuncWords, contentWordsOnly);
