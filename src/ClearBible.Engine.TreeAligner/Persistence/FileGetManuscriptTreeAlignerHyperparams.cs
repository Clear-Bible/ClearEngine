...
{
    public class FileGetManuscriptTreeAlignerHyperparams : IPersistGettable<FileGetManuscriptTreeAlignerHyperparams, ManuscriptTreeWordAlignerHyperparameters>
    {
        private string? PathPrefix { get; set; }

        private string AddPathPrefix(string s) => Path.Combine(PathPrefix ?? "", s);

        public FileGetManuscriptTreeAlignerHyperparams()
        {
        }
        public override IPersistGettable<FileGetManuscriptTreeAlignerHyperparams, ManuscriptTreeWordAlignerHyperparameters> SetLocation(string location)
        {
            PathPrefix = location;
            return this;
        }
        public override async Task<ManuscriptTreeWordAlignerHyperparameters> GetAsync()
        {
            ...
            return await Task.Run(() => new ManuscriptTreeWordAlignerHyperparameters(
                strongs,
                //glossTable,
                oldLinks,
                goodLinks,
